...
#if !defined(LOR_ENABLE_STATUS) && !defined(LOR_ENABLE_MEMORY) && !defined(LOR_ENABLE_STRING) && !defined(LOR_ENABLE_ARRAY) && !defined(LOR_ENABLE_MAP) && !defined(LOR_ENABLE_SET) && !defined(LOR_ENABLE_CLI)
