...
| nob                        | Alexey Kutepov / Tsoding                            | MIT or public domain | inspiration | Study copies removed. Informed dynamic-array ergonomics; build tooling remains outside liblor.     |
