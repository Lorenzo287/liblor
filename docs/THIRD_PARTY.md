...
| PCG / `references/rand/`          | Melissa O'Neill; Lorenzo Tumini; MagicalBait        | Apache-2.0 / MIT     | inspiration | PCG32 XSH-RR informed `lor/random.h`; liblor implements the published algorithm independently and copies no reference source. |
